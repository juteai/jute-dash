...
type HomeSettingsStore interface {
...
func (c *HomeController) handleSetupStatus(w http.ResponseWriter, r *http.Request) {
...
func (c *HomeController) handleHouseholdSettings(w http.ResponseWriter, r *http.Request) {
	switch r.Method {
	case http.MethodGet:
	...
	case http.MethodPatch:
		...
		display, err := model.NormalizeDisplaySettingsForSave(merged.Display)
		if err != nil {
...
func (c *HomeController) handleConnections(w http.ResponseWriter, r *http.Request) {
	switch r.Method {
	case http.MethodGet:
...
func (c *HomeController) handleConnectionKinds(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		httphelper.WriteMethodNotAllowed(w, http.MethodGet)
		return
	}
...
func (c *HomeController) handleRoomSettings(w http.ResponseWriter, r *http.Request) {
...
func (c *HomeController) handleTileSettings(w http.ResponseWriter, r *http.Request) {
...
func (c *HomeController) handleHome(w http.ResponseWriter, r *http.Request) {
	...
	httphelper.WriteJSON(w, http.StatusOK, service.FromConfig(settings.Home, rooms, tiles, time.Now()))
}
...
func (c *HomeController) handleConfigSliceSettings(
	w http.ResponseWriter,
	r *http.Request,
...
func (c *HomeController) handleConfigSliceSettingsTile(
	w http.ResponseWriter,
	r *http.Request,
...
func validateHouseholdSettings(settings HouseholdSettings) error {
	...
	probs := model.ValidateHome(settings.Home)
	if len(probs) > 0 {
